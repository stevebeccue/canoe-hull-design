%dxfwrite is replicated here to avoid portability issues.  HEY EVERYONE - FORWARDS AND BACKWARDS COMPATABLE!!!!   My thanks to the authors.
...
function [nb] = dxfwrite2 (filename, varargin)
